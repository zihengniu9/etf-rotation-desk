window.SHORT_PLAN = {
  ...
  "generated_at": "2026-09-04T16:24:03+08:00",
  "data_as_of": "2026-09-04",
  "for_date": "2026-09-07",
  "headline": "2026-09-04 收盘：盘后市场门控 65.5 分，开盘至收盘效果待取得；2026-09-07 先确认 龙版传媒 的核心反馈，再观察 播恩集团、楚天龙、中水渔业 的新晋龙头竞争；龙头观察另看 一鸣食品、百花医药、金健米业，不与连板池混排。",
  "market_review": "收盘涨停 41 家、跌停 0 家、炸板率 0.0%，最高 5 板；昨日涨停次日均值 -0.627%。当前计划由固定规则生成，不使用盘后信息反推次日必涨。",
  "branches": [
    {
      "key": "A",
      "title": "核心超预期 · 只保留最高身份",
      "condition": "龙版传媒 竞价不低于预期，非无法成交的一字加速；所属方向至少2只同步转强，开盘后承接不破关键均价。",
      "action": "只进入触发观察，不在竞价前预设成交；M门控继续允许且首次分歧承接确认后，再按既定仓位上限执行。"
    },
    {
      "key": "B",
      "title": "新晋龙头竞争 · 等市场选赢家",
      "condition": "播恩集团、楚天龙、中水渔业 中出现竞价与板块扩散同时占优者，且第一名相对第二名形成明确分差。",
  ...
  "watchlist": [
    {
      "name": "龙版传媒(605577)",
      "role": "短线核心 · M/S/E/Q 88.7分 · 重点观察",
      "trigger": "竞价不弱、非一字难成交，所属题材有同步扩散；S/E/Q状态不恶化",
      "action": "满足条件后进入观察；否则取消，不按静态排名直接买入"
    },
    {
      "name": "亚盛集团(600108)",
      "role": "短线核心 · M/S/E/Q 75.4分 · 重点观察",
      "trigger": "竞价不弱、非一字难成交，所属题材有同步扩散；S/E/Q状态不恶化",
      "action": "满足条件后进入观察；否则取消，不按静态排名直接买入"
    },
    {
      "name": "恒盛能源(605580)",
      "role": "短线核心 · M/S/E/Q 70.9分 · 观察",
      "trigger": "竞价不弱、非一字难成交，所属题材有同步扩散；S/E/Q状态不恶化",
      "action": "满足条件后进入观察；否则取消，不按静态排名直接买入"
    },
    {
